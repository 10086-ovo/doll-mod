...
<p align="center">
  ...
  <br/>
  召唤、武装、指挥 —— 8 种行为模式，全部玩法与配方都写在游戏内指南书里。
</p>
...
| 🧭 向导 | 结构 / 群系 / 村庄检索，可自建「全域索引」加快检索（进度可见、可取消） |
| 🛡️ 装备 | 海洋套装、7 种人偶头颅方块 |
| 🗡️ 武器 | 末影斧、下界剑、苍白弓、荆棘盾牌、向导的登山镐 |
...
- **建立「全域索引」时可能出现短暂卡顿**：日志可能报 `Can't keep up!`（单次约 1~2 秒），是服务端在演算结构位置；构建全程可见进度，可随时点击取消，已算好的部分会保留。
- **无已知运行时崩溃**。
