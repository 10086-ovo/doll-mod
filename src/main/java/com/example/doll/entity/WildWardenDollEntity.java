...
/**
 * 野生幽匿人偶 —— 独立于 DollEntity 体系的敌对生物。
 * 继承 Monster，使用原版 Goal 系统实现寻路/寻敌。
 * 250 HP / 8 攻击力 / 移动速度 0.3（仿监守者）。
 * 被攻击后反击，创造/旁观模式不锁定。
 * 40% 概率掉落头颅。
...
public class WildWardenDollEntity extends Monster {
	...
	private static final double WILD_MAX_HEALTH = 250.0;
	private static final double WILD_ATTACK_DAMAGE = 8.0;
	...
	private static final float SONIC_BOOM_DAMAGE = 5.0f;    // 音波伤害
