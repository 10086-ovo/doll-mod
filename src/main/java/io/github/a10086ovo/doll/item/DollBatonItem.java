...
public class DollBatonItem extends Item {
	...
	public InteractionResult interactLivingEntity(ItemStack stack, Player user, LivingEntity target, InteractionHand hand) {
		...
		if (!doll.isOwnedBy(user)) {
			io.github.a10086ovo.doll.DollMod.LOGGER.warn("[DollOwner] 指挥棒选中被拒: doll={} ownerUuid={} player={} uuid={}",
		...
		boolean isCombatMode = mode == io.github.a10086ovo.doll.mode.DollMode.MELEE.getIndex()
				|| mode == io.github.a10086ovo.doll.mode.DollMode.RANGED.getIndex();
		boolean isJobMode = mode == io.github.a10086ovo.doll.mode.DollMode.CHOP.getIndex()
				|| mode == io.github.a10086ovo.doll.mode.DollMode.FARM.getIndex()
				|| mode == io.github.a10086ovo.doll.mode.DollMode.MINE.getIndex();
		...
		if (doll.getActiveMode() != io.github.a10086ovo.doll.mode.DollMode.MINE.getIndex()) {
			if (doll.hasWorkArea()) {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		int mode = doll.getActiveMode();
		if (mode != io.github.a10086ovo.doll.mode.DollMode.CHOP.getIndex()
				&& mode != io.github.a10086ovo.doll.mode.DollMode.FARM.getIndex()
				&& mode != io.github.a10086ovo.doll.mode.DollMode.MINE.getIndex()) {
			player.sendSystemMessage(Component.translatable(
				"message." + DollModConstants.MOD_ID + ".baton_mode_required",
		...
		if (mode == io.github.a10086ovo.doll.mode.DollMode.MINE.getIndex()) {
	...
	/** Tooltip 显示当前选中的人偶名字。 */
	@Override
	@SuppressWarnings("deprecation") // 26.2 中 Item.appendHoverText 已被标记过时，但仍是唯一可覆写以追加自定义 tooltip 文本的钩子
