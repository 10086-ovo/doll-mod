 ...
 * 伤害加成由 {@link io.github.a10086ovo.doll.mixin.LivingEntityVulnerabilityMixin}
 * 在 {@code hurtServer} 中执行（每项易伤各自 ×1.5，即 +50%）。玩家和人偶射箭均生效。
 * <p>
 * 易伤与苍白人偶恐惧光环的 +50% 易伤按<b>加算</b>叠加：两项同处触发时总计 +100%（×2.0）。
 * 重复命中只刷新持续时间，不叠加倍率。
 * <p>
